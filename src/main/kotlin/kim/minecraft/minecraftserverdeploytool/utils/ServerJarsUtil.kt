...
class ServerJarsUtil(private val type: String) {
    ...
    private val latest: JSONObject =
        JSONObject.parseObject(IOUtil.doSimpleGet("https://serverjars.com/api/fetchLatest/$type"))
    ...
    fun getDownloadFileName(version: String): String {
        val json = JSONObject.parseObject(IOUtil.doSimpleGet("https://serverjars.com/api/fetchAll/$type"))
